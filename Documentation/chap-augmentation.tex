...
Tis is the main method on \texttt{add-lexical-variable} It
...
Tis is the main method on \texttt{add-special-variable} It
...
Tis is the main method on \texttt{add-local-symbol-macro} It
...
Tis is the main method on \texttt{add-variable-type} It
...
Tis is the main method on \texttt{add-variable-ignore} It
calls \texttt{describe-variable} to obtain an existing variable
...
Tis is the main method on \texttt{add-local-function}.  It
