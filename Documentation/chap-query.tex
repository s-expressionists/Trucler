...
\subsection{\texttt{global-p-mixin}}
\label{sec-global-p-mixin}

{\footnotesize
\Defclass {global-p-mixin}
}

This class is a superclass of query classes that provide information
about entities that need to be distinguished as to whether they are
global or not.  In particular, it is a superclass of the class
...
{\footnotesize
\Defmethod {global-p} {(description {\tt global-p-mixin})}
}

\Given{global-p-mixin} the global-p information, \Assupplied{:global-p}
...
\Given{class-name-mixin} the class-name information, \Assupplied{:class-name}
...
\Given{method-class-name-mixin} the method-class-name information, \Assupplied{:method-class-name}
...
\Given{superclass-names-mixin} the superclass-names information, \Assupplied{:superclass-names}
...
\Given{metaclass-name-mixin} the metaclass-name information, \Assupplied{:metaclass-name}
