...
\Given{type-mixin} the type information, as supplied by the initarg
\texttt{:type}.
...
\Given{ignore-mixin} the ignore information, as supplied by the initarg
\texttt{:ignore}.
...
\Given{dynamic-extent-mixin} the dynamic-extent information, as supplied by the initarg
...
\Given{expansion-mixin} the expansion information, as supplied by the initarg
\texttt{:expansion}.
...
\Given{expander-mixin} the expander information, as supplied by the initarg
\texttt{:expander}.
...
\Given{class-name-mixin} the class-name information, as supplied by the initarg
\texttt{:class-name}.
...
\Given{inline-mixin} the inline information, as supplied by the initarg
\texttt{:inline}.
...
\Given{method-class-name-mixin} the method-class-name information, as supplied by the
...
\Given{speed-mixin} the compilation-speed information, as supplied by the initarg
\texttt{:speed}.
...
\Given{compilation-speed-mixin} the compilation-speed information, as supplied by the initarg
...
\Given{debug-mixin} the debug information, as supplied by the initarg
\texttt{:debug}.
...
\Given{space-mixin} the space information, as supplied by the initarg
\texttt{:space}.
...
\Given{safety-mixin} the safety information, as supplied by the initarg
\texttt{:safety}.
...
\Given{superclass-names-mixin} the superclass-names information, as supplied by the
...
\Given{metaclass-name-mixin} the metaclass-name information, as supplied by the
