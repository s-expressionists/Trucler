...
\refSec{sec-instantiable-classes-variable-description}.  If no symbol
with the name \textit{name} exists in the current environment, then
this function returns \texttt{nil}.
...
in \refSec{sec-instantiable-classes-function-description}.
...
\refSec{sec-instantiable-classes-block-description}.
...
class described in \refSec{sec-instantiable-classes-tag-description}.
