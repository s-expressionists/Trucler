...
\Defmethod {ast} {(info {\tt local-function-info})}

Given an instance of the class \texttt{local-function-info}, this
method returns the \emph{ast} information of the local function as
supplied by the initarg \texttt{:ast}. If that initarg was not
supplied, this method returns \texttt{nil}.
